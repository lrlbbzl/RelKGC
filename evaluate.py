...
from rerank import rerank_by_graph, rerank_by_hop
...
def compute_metrics(hr_tensor: torch.tensor,
    ...
    for start in tqdm.tqdm(range(0, total, batch_size)):
        ...
        batch_score = torch.mm(hr_tensor[start:end, :], entities_tensor.t()) # bs, num_ent
        ...
        rerank_by_hop(batch_score, examples[start:end], entity_dict=entity_dict)
...
def predict_by_split():
    args.neighbor_weight, args.rerank_n_hop = 0.1, 5

...
parser.add_argument('--rerank-n-hop', default=3, type=int,
...
parser.add_argument('--rince-q', default=1.0, type=float, help='q value in rince loss')
parser.add_argument('--rince-lambda', default=0.5, type=float, help='lambda value in rince loss')

args = parser.parse_args()

assert not args.train_path or os.path.exists(args.train_path)
assert args.pooling in ['cls', 'mean', 'max']
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans', 'financial']

...
class Example:
    ...
    def vectorize(self) -> dict:
        ...
        # For financial without description
        # hr_encoded_inputs = _custom_tokenize(text=self.head, text_pair=self.relation)
        # head_encoded_inputs = _custom_tokenize(text=self.head)
        # tail_encoded_inputs = _custom_tokenize(text=self.tail)
